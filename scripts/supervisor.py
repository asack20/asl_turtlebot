...
class Supervisor:
    ...
    def __init__(self):
        ...
        # self.pose_goal_publisher = rospy.Publisher('/supervisor/cmd_pose', Pose2D, queue_size=10)

        # # Command vel (used for idling)
        # self.cmd_vel_publisher = rospy.Publisher('/supervisor/cmd_vel', Twist, queue_size=10)
    ...
    def has_stopped(self):
        ...
        #set rosparam multiplexer/control_mode to 'NAV'
    ...
    def set_control_mode(self, msg):
        rospy.set_param('/multiplexer/control_mode', msg)
    ...
    def loop(self):
        ...
        if self.prev_mode != self.mode:
            rospy.loginfo("Current supervisor mode: %s\r\n", self.mode)
